...
int main() {
  ...
  *p_cantilever = geometry();
  ...
  Log::Logger().Info(stiffMatGPU->GetStiffnessMatrix(), 40);
  delete stiffMatGPU;
...
Geometry& geometry() {
  // GEOMETRY (building the contiliver)
  float dimentionX = 200.0; int numberOfElementX = 4; // dimention of x and number of element in x
  float dimentionY = 100.0; int numberOfElementY = 2; 
