...
//__host__ __device__ StiffnessMatrix::StiffnessMatrix() { };
__host__ __device__ StiffnessMatrix::StiffnessMatrix(Material& mat, Geometry& geo, unsigned int n)
...
__host__ __device__ void StiffnessMatrix::integrationPoint()
