...
__host__ __device__ void StiffnessMatrixFirstOrder::constantCreator(unsigned int numberElement, float* c, float* x, float* y, unsigned int* mesh)
{
...
__host__ __device__ void StiffnessMatrixFirstOrder::stiffnessMatrixCalculation(unsigned int numberElement, unsigned int noIP, unsigned int nip ,float* in, unsigned int* ip, float* iw, float* c, float* D, float* k)
...
//__device__ StiffnessMatrixFirstOrder::StiffnessMatrixFirstOrder() { };
__host__ __device__ StiffnessMatrixFirstOrder::StiffnessMatrixFirstOrder(Material& mat, Geometry& geo, unsigned int n)
...
__host__ __device__ StiffnessMatrixFirstOrder::~StiffnessMatrixFirstOrder()
{
  #if __CUDA_ARCH__
...
__host__ float* StiffnessMatrixFirstOrder::GetStiffnessMatrix()
{
...
__host__ void StiffnessMatrixFirstOrder::DOFCreator(unsigned int numberElement, unsigned int noIP)
{
