...
public:
  ...
  CUDA_HOSTDEV void stiffnessMatrixCalculation(unsigned int, unsigned int, float*, unsigned int*, float*, float*, float*, unsigned int* ,float*, unsigned int*, unsigned int*, unsigned int*);
