...
public:
  ...
  CUDA_HOSTDEV void stiffnessMatrixCalculation(unsigned int, unsigned int, double*, unsigned int*, double*, double*, double*, unsigned int* ,double*, unsigned int*, unsigned int*, unsigned int*, unsigned int*);
  CUDA_HOSTDEV void stiffnessMatrixCalculation2(unsigned int, unsigned int, double*, unsigned int*, double*, double*, double* ,double*);
